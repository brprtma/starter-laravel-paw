  ...
  <body>
    <div id="wrapper">
      ...
      <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
          ...
          <li class="nav-item">
            <a class="nav-link" aria-current="page" href="/hero">Hero</a>
          </li>
          <li class="nav-item">
      ...
      <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div id="content">
              <div class="profile-ml">
                  <img src="images/ml_logos.jpg" alt="logo-mobile-legend">
              </div>
          ...
          <footer>
              <div class="icon-group">
                  <div class="github-icon">
                      <img src="images/github.png" alt="github logo" class="image-logo">
                      <h4>Github</h4>
                  </div>
                  <div class="ig-icon">
                      <img src="images/instagram.png" alt="instagram logo" class="image-logo">
                      <h4>Instagram</h4>
                  </div>
                  <div class="linkedin-icon">
                      <img src="images/linkedin.png" alt="linkedin logo" class="image-logo">
                      <h4>Linkedin</h4>
                  </div>
              </div>
          </footer>
